...
@pytest.mark.parametrize(
    ...
    [
        (1, False, 35, 180, 200, 16, 200000, 2000, 0, 2000, 0, 20,
         0, 0, 434, 40, 20863, 90, 1.5),
        (2, False, 35, 180, 200, 16, 200000, 2000, 0, 2000, 0, 20,
         0, 0, 434, 40, 62336, 90, 1.5),
        (3, True, 35, 180, 200, 16, 200000, 2000, 0, 2000, 0, 20,
         500, 200, 434, 40, 216096, 90, 1.5),
    ],
)
def test_v_rd(
    approx_lvl, reinforcment, fck, z,
