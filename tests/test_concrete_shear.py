...
@pytest.mark.parametrize(
    ...
    [
        ...
        (2, 3, True, 35, 180, 200, 16, 200000, 2000, 0, 2000, 0, 20, 90, 1.5, 500, 200, 434, 40, 126506),
        (2, 2, True, 35, 180, 200, 16, 200000, 2000, 0, 2000, 0, 20, 90, 1.5, 500, 200, 434, 40, 232749),
        (2, 1, True, 35, 180, 200, 16, 200000, 2000, 0, 2000, 0, 20, 90, 1.5, 500, 200, 434, 40, 216096),
    ],
)
def test_v_rd(
    approx_lvl_c, approx_lvl_s, reinforcment, fck, z,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (100e3, 1, 35, 200, 40, 180, 200000, 2000, 0, 10e3, 10e3, 20, 90, 150, 50000, 1.5, True),
        (10000e3, 1, 35, 200, 40, 180, 200000, 2000, 0, 10e3, 10e3, 20, 90, 150, 50000, 1.5, False),
    ],
)
def test_t_rd(
        t_ed, approx_lvl_s, fck, bw, theta, z, E_s, As,
