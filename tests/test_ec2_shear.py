...
@pytest.mark.parametrize(
    ...
    [
        (20, 250, 200, 100, 5e4, 30000, .15, 1.5, 20538),
        (37.5, 450, 1000, 500, 1e8, 250000, .15, 1.5, 283334),
        (20, 250, 0, 100, 5e4, 30000, .15, 1.5, 16425),
        (37.5, 450, 0, 500, 1e8, 250000, .15, 1.5, 272475),
    ],
)
