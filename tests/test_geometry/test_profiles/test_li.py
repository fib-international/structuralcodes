...
def test_LI_geometric_data(
    ...
    """Test LI profile geometric data matches JSON data."""
...
def test_LI_massprop_data(
    ...
    """Test LI profile mass property matches JSON data."""
    # Delete not used variables to avoid linting errors
    del (
        h_mm,
        b_mm,
...
def test_LI_polygon(
    ...
    poly2 = LI.get_polygon(profile_name)
