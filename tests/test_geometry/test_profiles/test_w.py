...
def test_w_geometric_data(
    ...
    """Test W profile geometric data matches JSON data."""
...
def test_w_massprop_data(
    ...
    """Test W profile mass property matches JSON data."""
    # Delete not used variables to avoid linting errors
    del (
        h_mm,
        b_mm,
...
def test_w_invalid_name(
    invalid_name,
):
    """Test W profile with invalid name raises ValueError."""
    # Invalid name for constructor
    with pytest.raises(ValueError):
        W(invalid_name)
    # Invalid name for class method
    with pytest.raises(ValueError):
        W.get_polygon(invalid_name)
...
def test_w_massprops_polygon(
    ...
    """Test W profile massprops from polygon."""
    # Delete not used variables to avoid linting errors
    del (
        tw_mm,
        tf_mm,
    ...
    # Create geometry
    geo = SurfaceGeometry(W.get_polygon(profile_name), material=steel)
    # Create the section
