...
def fctd(fctk: float, alpha_ct: float = 1.0, gamma_c: float = 1.5) -> float:
    """The design tensile strength of concrete.

    Defined in fib Model Code 2010 (2013), Eq. 7.2-12.

    Args:
        fctk (float): The characteristic tensile strength in MPa.
    ...
    """
    return abs(alpha_ct) * abs(fctk) / abs(gamma_c)
